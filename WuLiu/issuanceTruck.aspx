        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 458px; height: 270px">
            ...
            <tr>
                ...
                <td style="width: 311px; height: 19px">
                    <asp:TextBox ID="txtTruckLong" runat="server" Width="64px"></asp:TextBox>米</td>
            ...
            <tr>
                ...
                <td style="width: 311px; height: 24px;">
                    <asp:TextBox ID="txtLoad" runat="server" Width="65px"></asp:TextBox>吨</td>
            ...
            <tr>
                ...
                <td style="width: 111px">
                    联系人：</td>
                <td style="width: 311px">
                    <asp:TextBox ID="txtLinkman" runat="server" Width="64px"></asp:TextBox></td>
                <td style="width: 100px">
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 111px; height: 24px">
                    联系电话：</td>
                <td style="width: 311px; height: 24px">
                    <asp:TextBox ID="txtPhone" runat="server" Width="92px"></asp:TextBox></td>
                <td style="width: 100px; height: 24px">
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 111px">
                    有效时间：</td>
                <td style="width: 311px">
                    <asp:TextBox ID="txtTerm" runat="server" Width="83px"></asp:TextBox></td>
                <td style="width: 100px">
                </td>
            </tr>
            <tr>
